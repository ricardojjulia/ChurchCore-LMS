...
--
-- UUID namespace 00c0 is reserved for this file (0090 and 0095 belong to other e2e tests); 0002 (profiles), 0010 (orgs),
...
VALUES ('00000000-0000-0000-00c0-000000000001',
...
VALUES
  ('00000000-0000-0000-00c0-000000000101', '00000000-0000-0000-0011-000000000001', NULL,
   'module_header', 'Suite Module 1', 1, '{}', '{}', '{}', true, '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000102', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   'page', 'Suite Lesson Page', 2, '{"body": "<p>Welcome to the suite lesson.</p>"}', '{}', '{"base_xp_reward": 10}', true,
   '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000103', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   ...
   '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000104', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   'quiz', 'Suite Quiz', 4,
   ...
   '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000105', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   'discussion', 'Suite Discussion', 5, '{"prompt": "Share one takeaway.", "max_score": 10}', '{}', '{}', true,
   '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000106', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   'attendance', 'Suite Attendance', 6, '{"session_title": "Week 1", "tracking_mode": "both", "points_possible": 5}', '{}', '{}', true,
   '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000108', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   'video_stream', 'Suite Video', 6.5, '{"url": "https://www.youtube.com/watch?v=dQw4w9WgXcQ", "duration_minutes": 3, "requirements": {"must_view": true}}', '{}', '{}', true,
   '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000109', '00000000-0000-0000-0011-000000000001', '00000000-0000-0000-00c0-000000000101',
   'quiz', 'Suite Bank Quiz', 6.7,
...
VALUES ('00000000-0000-0000-00c0-000000000201', '00000000-0000-0000-0011-000000000001',
        'Suite Content Page',
...
VALUES ('00000000-0000-0000-00c0-000000000401', 'Suite Program Track', 'SUITE-TRACK', 'Suite fixture', true,
...
VALUES ('00000000-0000-0000-00c0-000000000401', '00000000-0000-0000-0011-000000000001', 1, true)
ON CONFLICT DO NOTHING;

INSERT INTO public.global_cohorts (id, cohort_name, cohort_code, program_track_id, description, is_active, created_by, org_id)
VALUES ('00000000-0000-0000-00c0-000000000301', 'Suite Cohort', 'SUITE-COHORT', '00000000-0000-0000-00c0-000000000401',
...
VALUES ('00000000-0000-0000-00c0-000000000302', '00000000-0000-0000-00c0-000000000301',
...
VALUES ('00000000-0000-0000-00c0-000000000501', '00000000-0000-0000-0010-000000000001',
...
VALUES ('00000000-0000-0000-00c0-000000000502', '00000000-0000-0000-00c0-000000000501', 'multiple_choice',
...
VALUES ('00000000-0000-0000-00c0-000000000601', '00000000-0000-0000-0010-000000000001',
        'Suite Learning Path', 'Suite fixture path', true)
ON CONFLICT DO NOTHING;

INSERT INTO public.learning_path_courses (id, path_id, course_id, sort_order)
VALUES
  ('00000000-0000-0000-00c0-000000000602', '00000000-0000-0000-00c0-000000000601', '00000000-0000-0000-0011-000000000001', 1),
  ('00000000-0000-0000-00c0-000000000603', '00000000-0000-0000-00c0-000000000601', '00000000-0000-0000-0011-000000000005', 2)
ON CONFLICT DO NOTHING;

-- ─── Groups ──────────────────────────────────────────────────────────────────

INSERT INTO public.section_groups (id, section_id, group_name, group_code, max_members, purpose, created_by, org_id)
VALUES ('00000000-0000-0000-00c0-000000000701', '00000000-0000-0000-0022-000000000001',
...
VALUES
  ('00000000-0000-0000-00c0-000000000702', '00000000-0000-0000-00c0-000000000701',
   (SELECT id FROM auth.users WHERE email = 'student@test.churchcore.dev'), 'member', '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000703', '00000000-0000-0000-00c0-000000000701',
...
VALUES ('00000000-0000-0000-00c0-000000000704', '00000000-0000-0000-00c0-000000000701', 'Suite Group Thread',
        (SELECT id FROM auth.users WHERE email = 'teacher@test.churchcore.dev'), '00000000-0000-0000-0010-000000000001')
ON CONFLICT DO NOTHING;
...
VALUES ('00000000-0000-0000-00c0-000000000801', 'direct', 'Suite Thread',
...
VALUES
  ('00000000-0000-0000-00c0-000000000802', '00000000-0000-0000-00c0-000000000801',
   '00000000-0000-0000-0002-000000000002', 'owner', true, '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000803', '00000000-0000-0000-00c0-000000000801',
...
VALUES ('00000000-0000-0000-00c0-000000000804', '00000000-0000-0000-00c0-000000000801',
...
VALUES
  ('00000000-0000-0000-00c0-000000000e01', '00000000-0000-0000-0002-000000000003',
   '00000000-0000-0000-0011-000000000001', 'in_progress', 20, NULL, '00000000-0000-0000-0010-000000000001'),
  ('00000000-0000-0000-00c0-000000000e02', '00000000-0000-0000-0002-000000000003',
...
VALUES ('00000000-0000-0000-00c0-000000000901', '00000000-0000-0000-0002-000000000003',
...
VALUES ('00000000-0000-0000-00c0-000000000a01', '00000000-0000-0000-0002-000000000001', 'global',
...
VALUES ('00000000-0000-0000-00c0-000000000b01', '00000000-0000-0000-0002-000000000001', 'institutional',
...
VALUES ('00000000-0000-0000-00c0-000000000c01', '00000000-0000-0000-0002-000000000003', 'system',
...
VALUES ('00000000-0000-0000-00c0-000000000d01', 'suite_badge', 'Suite Badge', 'Suite fixture badge',
        '00000000-0000-0000-0010-000000000001')
ON CONFLICT DO NOTHING;

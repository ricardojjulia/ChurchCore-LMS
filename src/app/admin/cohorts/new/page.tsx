    ...
    <main id="main-content" className="min-h-screen bg-slate-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-xl mx-auto">
        <nav className="flex items-center gap-2 text-sm text-slate-400 mb-6">
          <Link href="/admin/cohorts" className="hover:text-primary transition-colors font-medium">Cohorts</Link>
          <span>/</span>
          <span className="text-foreground font-semibold">New</span>
        </nav>

        <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
          <h1 className="text-xl font-extrabold text-foreground mb-6">New Cohort</h1>
          <NewCohortForm tracks={tracks ?? []} />
        </div>
      </div>
    </main>
  )

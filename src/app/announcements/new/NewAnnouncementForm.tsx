      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border border-border rounded-2xl p-6 space-y-5">
          ...
          <div>
            ...
            {scope === 'course' && (
              <div className="mt-2">
                <label htmlFor="course-select" className="block text-xs font-medium text-slate-600 mb-1">
                  Course <span className="text-destructive">*</span>
                </label>
                {courses.length === 0 ? (
                  <p className="text-xs text-muted-foreground">No published courses available.</p>
                ) : (
                  <select
                    id="course-select"
                    value={courseId}
                ...
                <p className="text-xs text-muted-foreground mt-1">Visible only to students enrolled in this course.</p>
              </div>
            )}
          </div>
